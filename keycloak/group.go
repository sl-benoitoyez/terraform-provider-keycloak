...
func (keycloakClient *KeycloakClient) GetGroupMembers(realmId, groupId string, pagination int) ([]*User, error) {
	var users []*User
	var first int = 0
	var iterationUsers []*User

	for ok := true; ok; ok = (len(iterationUsers) > 0 && pagination != -1) {
